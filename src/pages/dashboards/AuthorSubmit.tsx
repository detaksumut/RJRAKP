...
export default function AuthorSubmit() {
  ...
  const getPackageDetails = (type: string) => {
    switch (type) {
      ...
      case 'jurnal_kuliah':
        return { price: 'Rp 300.000', label: 'Jurnal Perkuliahan (Non SINTA) (Biaya Publish: Rp 300.000)', name: 'Jurnal Perkuliahan (Non SINTA)' };
      default:
        return { price: 'Rp 2.500.000', label: 'Paket Publikasi Jurnal Internasional (Non SINTA) (All In)', name: 'Jurnal Internasional (Non SINTA)' };
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {success ? (
          <div className="bg-emerald-50 border border-emerald-200 text-emerald-800 p-6 rounded-xl text-center mb-8 shadow-sm">
            ...
            {submittedPkg?.name === 'Jurnal Perkuliahan (Non SINTA)' ? (
              <div className="bg-white border border-brand-200 rounded-xl p-6 text-left mb-8 shadow-sm">
                <h4 className="text-brand-800 font-bold mb-2">Pemberitahuan Biaya Publikasi & Review (Jurnal Perkuliahan)</h4>
                <p className="text-brand-700 text-sm mb-4 leading-relaxed font-medium">
                  Pengajuan artikel Anda untuk kategori <strong>Jurnal Perkuliahan (Non SINTA)</strong> telah berhasil diterima oleh sistem. Rincian konfirmasi pengajuan resmi beserta petunjuk pembayaran telah dikirimkan ke alamat email Anda (<strong>{user?.email}</strong>). Penulis diminta untuk segera mentransfer <strong>Biaya Review & Publikasi</strong> sebesar <strong>Rp 300.000</strong> ke rekening di bawah ini:
                </p>
                ...
                <div className="bg-brand-50 p-4 rounded-lg flex flex-col md:flex-row items-center gap-4 justify-between border border-brand-100">
                  ...
                  <div className="text-left md:text-right border-t md:border-t-0 md:border-l border-brand-200/50 pt-3 md:pt-0 md:pl-6">
                    ...
                    <span className="block text-2xl font-black text-brand-900 tracking-wider">Rp 300.000</span>
                  </div>
                </div>
              </div>
            ) : (
              <div className="bg-white border border-brand-200 rounded-xl p-6 text-left mb-8 shadow-sm">
                ...
                <p className="text-brand-700 text-sm mb-4 leading-relaxed font-medium">
                  {!submittedPkg?.name?.includes('Internasional') ? (
                    <>
            ...
            <form onSubmit={handleSubmit} className="divide-y divide-academic-100">
              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div>
                  ...
                  >
                    <option value="international">Publikasi Jurnal Internasional (Non SINTA) (Biaya Publish: Rp 2.500.000)</option>
                    <option value="jurnal_kuliah">Jurnal Perkuliahan (Non SINTA) (Biaya Publish: Rp 300.000)</option>
