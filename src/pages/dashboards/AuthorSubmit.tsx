...
export default function AuthorSubmit() {
  ...
  const getPackageDetails = (type: string) => {
    switch (type) {
      case 'sinta_6':
        return { price: '-', label: 'Paket Publikasi Jurnal SINTA 6 (All In)', name: 'SINTA 6' };
      case 'sinta_5':
        return { price: '-', label: 'Paket Publikasi Jurnal SINTA 5 (All In)', name: 'SINTA 5' };
      case 'sinta_4':
        return { price: '-', label: 'Paket Publikasi Jurnal SINTA 4 (All In)', name: 'SINTA 4' };
      case 'sinta_3':
        return { price: '-', label: 'Paket Publikasi Jurnal SINTA 3 (All In)', name: 'SINTA 3' };
      case 'sinta_2':
        return { price: '-', label: 'Paket Publikasi Jurnal SINTA 2 (All In)', name: 'SINTA 2' };
      case 'sinta_1':
        return { price: '-', label: 'Paket Publikasi Jurnal SINTA 1 (All In)', name: 'SINTA 1' };
      case 'jurnal_kuliah':
        return { price: '-', label: 'Jurnal Perkuliahan (Non SINTA)', name: 'Jurnal Perkuliahan (Non SINTA)' };
      default:
        return { price: '-', label: 'Paket Publikasi Jurnal Internasional (Non SINTA) (All In)', name: 'Jurnal Internasional (Non SINTA)' };
    }
  };
            ...
            <form onSubmit={handleSubmit} className="divide-y divide-academic-100">
              ...
              <div className="p-6 md:p-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-academic-500 mt-1.5 leading-relaxed">
                    Khusus untuk submitter yang meminta diterbitkan ikut SINTA, proses pendampingan mencakup terbit di RJRAKP (terindeks Google Scholar, terbit Zenodo, terindeks di OpenAIRE, dan terdaftar di ORCID). Khusus untuk Web of Science (tulisan tertentu) & SSRN Elsevier.
                  </p>
                </div>
                <div>
