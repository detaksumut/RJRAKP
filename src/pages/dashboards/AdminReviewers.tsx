        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl border border-academic-200 shadow-sm overflow-hidden mb-6">
            <div className="px-6 py-4 border-b border-academic-100 flex justify-between items-center bg-academic-50">
              <h2 className="font-bold text-lg text-academic-900">Verifikasi Reviewer</h2>
  ...
  return (
    <DashboardLayout>
      <div className="max-w-6xl">
        <div className="mb-8">
          <h1 className="text-2xl font-serif font-bold text-academic-900 mb-2">Verifikasi Reviewer</h1>
          <p className="text-academic-500">Daftar calon Reviewer yang menunggu verifikasi dari Administrator.</p>
        </div>
