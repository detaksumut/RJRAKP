        ...
        <AuthProvider>
          <div className="min-h-screen bg-academic-50 font-sans text-academic-800 selection:bg-brand-100 selection:text-brand-900 flex flex-col overflow-x-hidden">
            ...
            <a 
              ...
              className="fixed bottom-6 right-6 z-[999] transition-all duration-300 hover:scale-105 hover:-translate-y-1 shadow-[0_8px_30px_rgb(0,0,0,0.12)] bg-white/95 backdrop-blur-md rounded-2xl overflow-hidden flex items-center justify-center w-28 h-10 sm:w-36 sm:h-12 border border-slate-200/50"
              title="Powered by Open Journal Systems"
            >
              <img 
                src="/logoOJS_3.png" 
                alt="Open Journal Systems" 
                className="w-full h-full object-cover scale-[1.8] sm:scale-[2] transition-transform duration-500 hover:scale-[2.1]"
              />
            </a>
