import { ArrowRight, Search, BookOpen, Sparkles, ShieldCheck, Globe } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-4 items-center">
              <a 
                href="/#jurnal" 
                className="flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-black text-xs shadow-lg text-brand-950 bg-gradient-to-r from-accent-400 to-amber-400 hover:from-accent-500 hover:to-amber-500 hover:shadow-accent-500/20 hover:shadow-xl transition-all hover:-translate-y-0.5 duration-200 uppercase tracking-widest"
              >
                Membaca Jurnal <ArrowRight className="w-4 h-4" />
              </a>
              <a 
                href="/pedoman" 
                className="flex items-center justify-center gap-2 px-8 py-4 border border-white/15 text-xs font-black rounded-xl text-white bg-white/5 hover:bg-white/10 hover:border-white/30 transition-all hover:-translate-y-0.5 duration-200 uppercase tracking-widest"
              >
                Panduan Penulis
              </a>
            </div>
