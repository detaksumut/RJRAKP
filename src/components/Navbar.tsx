        ...
        <div className="flex justify-between py-2 items-center">
          ...
          <div className="flex flex-1 justify-center px-2">
            <a href="https://scholar.google.com/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-blue-50/50 hover:bg-blue-50 border border-blue-100 transition-all shadow-sm group">
              <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 group-hover:scale-110 transition-transform" fill="currentColor" fillOpacity={0.2} />
              <span className="text-xs sm:text-sm font-bold text-blue-900 tracking-wide whitespace-nowrap">Google Scholar</span>
            </a>
          </div>
